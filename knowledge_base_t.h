#ifndef __KNOWLEDGE_BASE_T_H__
#define __KNOWLEDGE_BASE_T_H__
...
public:
    ...
    virtual string to_string(const knowledge_base_t& kf) const = 0;
	virtual string dump() const = 0;
	virtual void dump(std::ostream& out) const = 0;
	virtual void load(std::istream& in) = 0;
    virtual string to_xml(const knowledge_base_t& kf) const = 0;
};
...
public:
    ...
    virtual string to_string(const knowledge_base_t&) const override;
	virtual string dump() const override;
	virtual void dump(std::ostream& out) const override;
	virtual void load(std::istream& in) override;
    virtual string to_xml(const knowledge_base_t& kf) const override;
};
...
public:
    ...
    virtual string to_string(const knowledge_base_t& kf, bool in_brackets, const string& left_delimeter = " ", const string& right_delimeter = " ") const = 0;
	virtual string dump() const = 0;
	virtual void dump(std::ostream& out) const = 0;
	virtual void load(std::istream& in) = 0;
    virtual string to_interval_xml(const knowledge_base_t& kf) const = 0;
    virtual string to_rule_xml(const knowledge_base_t& kf) const = 0;
...
public:
    ...
    virtual string to_string(const knowledge_base_t& kf, bool in_brackets, const string& = " ", const string& = " ") const override;
	virtual string dump() const override;
	virtual void dump(std::ostream& out) const override;
	virtual void load(std::istream& in) override;
    virtual string to_interval_xml(const knowledge_base_t&) const override;
    virtual string to_rule_xml(const knowledge_base_t&) const override;
...
public:
    ...
    virtual string to_string(const knowledge_base_t& kf, bool in_brackets, const string& left_delimeter = " ", const string& right_delimeter = " ") const override;
	virtual string dump() const override;
	virtual void dump(std::ostream& out) const override;
	virtual void load(std::istream& in) override;
    virtual string to_interval_xml(const knowledge_base_t&) const override;
    virtual string to_rule_xml(const knowledge_base_t& kf) const override;
	virtual bool is_temporal() const override;
};
...
public:
	...
	virtual void dump(std::ostream& out) const override;
	virtual void load(std::istream& in) override;
    virtual string to_interval_xml(const knowledge_base_t& kf) const override;
    virtual string to_rule_xml(const knowledge_base_t& kf) const override;
	virtual bool is_temporal() const override;
};
...
public:
    ...
    virtual string to_string(const knowledge_base_t &kf) const override;
	virtual string dump() const override;
	virtual void dump(std::ostream& out) const override;
	virtual void load(std::istream &in) override;
    virtual string to_xml(const knowledge_base_t& kf) const override;
...
private:
    ...
    // vector<KBEntity *> _objects;
    // vector<temporal_interval_t*> _intervals;
    // vector<KBRule*> _rules;
    // vector<KBOperation*> _events;

    // map<string,KBEntity *> _mp_objects;
    // map<string,temporal_interval_t*> _mp_intervals;
    // map<string,KBRule*> _mp_rules;
    // map<string,KBOperation*> _mp_events;
...
public:
    ...
    const KBEntity* _add_object(const string& name);
